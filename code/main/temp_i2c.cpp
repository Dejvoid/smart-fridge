...
void Temperature::loop() {
    ...
    //i2c_master_write_read_device(I2C_MASTER_NUM, addr, NULL, 0, rd_buf, rd_len, I2C_MASTER_TIMEOUT_MS / portTICK_PERIOD_MS);
    //i2c_master_write_to_device(I2C_MASTER_NUM, addr, init_cmd, sizeof(init_cmd), I2C_MASTER_TIMEOUT_MS / portTICK_PERIOD_MS);
    if (rd_buf[0]) {
